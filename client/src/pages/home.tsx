...
import { Loader2, Upload, Link2, Mail } from "lucide-react";
...
export default function Home() {
  ...
  const isLoading = analyzeMutation.isPending || audioMutation.isPending;
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <Card className="bg-slate-800 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription>YouTube, Google Meet, Zoom</CardDescription>
                </CardHeader>
